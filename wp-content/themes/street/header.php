                                            ...
                                            <ul class="sm-megamenu-hover sm_megamenu_menu sm_megamenu_menu_black" data-jsapi="on">
                                                ...
                                                <li class="other-toggle   
                                                    ...
                                                    <div class="sm_megamenu_dropdown_6columns  
                                                         " >
                                                        <div class="sm_megamenu_content"><div id="messages_product_view"></div>
                                                            <div class="contact-map-wrap col-lg-5 col-md-5 col-sm-6 col-xs-12">
                                                            ...
                                                            <form class="contact-form col-lg-7 col-md-7 col-sm-6 col-xs-12" action="<?php echo get_site_url() ?>/contacts/index/post/" id="contactForm" method="post">
                                                                <div class="fieldset">
                                                                    <ul class="form-list">
                                                                        ...
                                                                        <li class="wide">
                                                                            <div class="input-box">
                                                                                <textarea name="comment" id="comment" title="Comment" onfocus="if (this.value == 'Comment...')
                                                                                            this.value = '';" onblur="if (this.value == '')
                                                                                                        this.value = 'Comment...';" value="Comment..." class="required-entry input-text" cols="10" rows="7">Comment...</textarea>
                                                                            </div>
                                                                        </li>
                                                                    </ul>
                                                                </div>
